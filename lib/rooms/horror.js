...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      <br>
      You are shaking, too afraid to read on.  You look over your shoulder at the boarded up window, your eyes widening.  You see the light outside the window shift and find yourself near panicking.  Is something out there?  You turn to put the paper back and notice a glint of light on brass.  It's a key.</span>`,
  ...
  await Item.create({
    ...
    interactions: {
      ...
      useunlocked: 'You open the door... You find yourself back in the libraryinth.  You take breath of relief to find you have escaped The Virus.'
  ...
  await Item.create({
    ...
    interactions: {
      ...
      usedoor: 'You move towards the door and find the key in your pocket.  You put it into the keyhole, and hesitate for a moment as you recall the chair. You decide to unlock the door.'
    }
  });
