...
module.exports = async() => {
  ...
  await Item.create({
    ...
    takeable: true,
    interactions: {
      look: 'You look closer at the <span class="object">rock</span>.  Time seems to stand still as you examine it more closely.  Its jagged edges and bright sparkle call to you.  Should you take it?',
  ...
  await Item.create({
    ...
    interactions: {
      ...
      talk: 'The <span class="object">alien</span> speaks to you telepathically and explains that they will give you the <span class="object">key</span> in return for the <span class="object">rock</span>.'
    }
  });
