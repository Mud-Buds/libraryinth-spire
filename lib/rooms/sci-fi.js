...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      useunlocked: 'You settle into the <span>spaceship</span> and hand the <span>alien</span> the <span>rock</span>.  You are sad to part with it, but happy to have access to the <span>spaceship</span>.  You wave to the <span>alien</span> and they wish you safe travels as they set the <span>spaceship\'s</span> navigation to Earth.  The <span>dome</span> seems to disappear as the <span>spaceship</span> rises above the planet. You look out with wonder and blink.  When you open your eyes, you find yourself back in the libraryinth.'
    }
  });
};
