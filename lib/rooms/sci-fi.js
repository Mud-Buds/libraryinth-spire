...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      take: 'You can`t take the alien, but can the alien take you?',
      use: 'You can`t use the alien.',
      talk: ''
    }
  });
