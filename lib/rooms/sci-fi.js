...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      talk: 'The <span class="object">alien</span> speaks to you telepathically and explains that they will give you the <span class="object">key</span> in return for the <span class="object">rock</span>.  You can give the <span class="object">rock</span> to the <span class="object">alien</span> and gain access to the <span class="object">spaceship</span>'
    }
  });
