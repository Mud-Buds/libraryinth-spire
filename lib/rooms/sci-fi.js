...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      useplant: 'You smash the plants up with the rock into a paste.  You apply the paste onto your hand ',
      usedome: 'You take the rock and use it to smash the glass-like exterior of the dome until you create an opening that is large enough.'
    }
  });
  ...
  await Item.create({
    ...
    interactions: {
      ...
      useplant: 'You smash the plants up with the rock into a paste.  You apply the paste onto your hand and immediately the pain dissipates and the swelling goes down.',
      inventoryuse: 'What are you trying to smash?',
    }
  });
