...
module.exports = async() => {
  ...
  const user = await User.create({
    ...
    state: {
      horrorDoor: 'locked',
      foundRoderick: false,
      greenCreatureDead: false,
      redCreatureDead: false,
    }
    // password: '1234'
  });
  ...
  await Item.create({
    ...
    takeable: true,
    interactions: {
      look: 'You see a book title "The Siege".',
      take: 'You take the book',
      use: 'You get teleported this is a test sentence.'
    }
  });
