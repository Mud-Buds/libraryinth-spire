...
module.exports = async() => {
  ...
  await Item.create({
    ...
    takeable: true,
    interactions: {
      look: 'You look at the book and it gives you a strange, foreign feeling. You run your fingers over the impressions the title makes in the book cover. "<span class="object">Interstellar</span>," you say it out loud.  "Hmmm..."',
