...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      ...
      look: 'You approach the <span class="object">bookshelves</span> and see a beautifully ordaned book. You take a look at the spine and the title is "<span class="object">Siege</span>". You swear you hear trumpets coming from within the book.',
