...
module.exports = async() => {
  ...
  await Item.create({
    ...
    takeable: true,
    interactions: {
      look: 'You look at the large leather bound book. You tilt your head to read the title on the spine and it reads "The Virus"',
  ...
  await Item.create({
    name: 'Intersellar Alien',
    room: libraryRoom._id,
    takeable: true,
    interactions: {
      look: 'You look at the book and it gives you a strange, foreign feeling. You run your fingers over the impressions th title makes in the book cover. "Interstellar Alien," you say it out loud.  "Hmmm..."',
