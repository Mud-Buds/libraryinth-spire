...
module.exports = async() => {
  ...
  await Item.create({
    ...
    takeable: true,
    interactions: {
      look: 'You approach the <span class="object">bookshelves</span> and see a beautifully ordaned book. You take a look at the spine and the title is "Siege". You swear you hear trumpets coming from within the book.',
