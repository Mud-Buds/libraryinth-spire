...
module.exports = async() => {
  ...
  await Item.create({
    ...
    interactions: {
      look: 'You hear the horns blowing in the distance. You open your eyes and see your <span class="object"> commander </span> telling everyone to get ready and head to there posts. The creatures and monsters are coming. You take a deep breath and look around, you see the <span class="object"> armory </span> next to you and your <span class="object"> commander </span> waiting nearby.',
  ...
  await Item.create({
    ...
    interactions: {
      ...
      usecreature: 'You raise your <span class="object">shield</span> and block the <span class="object">creatures</span> large swing. Your arm aches from the impact but you are safe.',
      usemonster: 'The <span class="object">monster</span> swarms you and tries stabbing you multiple times you block all of these blows with your sturdy <span class="object">shield</span>.'
    }
  });
  ...
  await Item.create({
    ...
    room: fantasyRoom._id,
    interactions: {
      look: 'You start to approach the <span class="object">wall</span> and see a raging battle before you, your fellow soldiers are battling the creatures on the parapets and <span class="object">wall</span>. The sound of metal crashing together mixed with battlecries fill your ears. You dont see the beacon keeper yet but there seems to be a <span class="object">creature</span> in your way!',
      take: 'You cant take the <span class="object">wall</span>...',
  ...
  await Item.create({
    ...
    interactions: {
      ...
      talk: '<span class="object">Creature</span>: "IM GOING TO EAT YOUR FLESH."'
    }
  });
  ...
  await Item.create({
    ...
    room: fantasyRoom._id,
    interactions: {
      look: 'You reach the large <span class="object">tower</span> and see it is full of soldiers shooting crossbows at the creatures climbing the ladders. Theres a break in the chaos and you see a <span class="object">captain</span> of the <span class="object">tower</span> standing nearby looking at you confused.',
      take: 'You cant take the <span class="object">tower</span>.',
      use: 'You cant use the <span class="object">tower</span>.',
      talk: 'You cant talk to the <span class="object">tower</span>.'
    }
  });
  ...
  await Item.create({
    ...
    interactions: {
      ...
      take: 'You cant take the <span class="object">captain</span>, he has his duty.',
      use: 'You cant use the <span class="object">captain</span>.',
  ...
  const monster = await Item.create({
    ...
    interactions: {
      ...
      talk: 'The <span class="object">monster</span> snarls and doesnt say anything.'
    }
  });
  ...
  const roderick = await Item.create({
    ...
    interactions: {
      ...
      take: 'You cant take <span class="object">Roderick</span>.',
      use: 'You cant use <span class="object">Roderick</span>.',
      talk: '<span class="object">Roderick</span>: "I dont have the energy to make it to the beacon tower. You will have to go. Take the <span class="object">key</span> from me and light the <span class="object">beacon</span>. Please hurry!"'
    }
  });
  ...
  const key = await Item.create({
    ...
    interactions: {
      ...
      usedoor: 'You use the <span class="object">key</span> on the <span class="object">beacon <span class="object">door</span>. A large mechanism starts turning and the beacon lights up the land blinding you. As your vision returns you see you are back in the Librarynth.',
      talk: 'You cant talk to the <span class="object">beacon</span>.'
    }
  });
  ...
  const beaconTower = await Item.create({
    ...
    interactions: {
      ...
      take: 'You cant take the <span class="object">beacon</span>.',
